...
public enum WorkflowEventType {
    ...
    /** One functional step result was restored from its deterministic cache. */
    ...
    /** A functional workflow requested external information and paused. */
    INPUT_REQUESTED("input-requested"),
    /** An application-defined functional workflow event was emitted. */
    CUSTOM("custom"),
    /** A functional workflow invocation paused before reaching an output. */
