 ...
 * @param structuredOutput optional provider-neutral JSON Schema response contract
...
public record ChatOptions(
    ...
    /**
     * Creates chat options using the constructor shape published before structured output support.
     *
     * @param model optional model identifier
     * @param temperature optional value from 0 through 2
     * @param topP optional value from 0 through 1
    ...
    public static final class Builder {
        ...
        private StructuredOutputOptions structuredOutput;
        ...
        /**
         * Sets a provider-neutral JSON Schema response contract.
         *
         * @param structuredOutput structured-output options
         * @return this builder
         */
        public Builder structuredOutput(StructuredOutputOptions structuredOutput) {
