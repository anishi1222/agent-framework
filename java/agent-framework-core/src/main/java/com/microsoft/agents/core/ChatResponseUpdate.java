...
/**
 * Represents one immutable streaming update from a chat client.
 *
 ...
 */
public record ChatResponseUpdate(
        Long sequence,
    ...
    /** Creates and defensively copies a chat response update. */
    ...
    /** Builds an immutable {@link ChatResponseUpdate}. */
    public static final class Builder {
        ...
        /** Sets the stable conversation identifier. */
