...
public final class MCPClient implements AutoCloseable {
    ...
    public CompletionStage<MCPReadResourceResult> readResourceAsync(URI uri) {
        return readResourceAsync(uri, new DefaultRunCancellation());
    }

    /**
     * Reads one resource with explicit cancellation.
     *
     * @param uri absolute resource URI
     * @param cancellation cancellation signal
     * @return resource contents stage
     */
    public CompletionStage<MCPReadResourceResult> readResourceAsync(URI uri, RunCancellation cancellation) {
