...
class ContextAndMiddlewareTest {
    ...
    void streamingMiddleware_shouldExecuteOnceInOrder_andSupportValidShortCircuit() {
        ...
        assertThat(subscriber.updates).singleElement().satisfies(update -> assertThat(update.text())
                .isEqualTo("streamed"));
        ...
        assertThat(shortSubscriber.updates).singleElement().satisfies(update -> assertThat(update.text())
                .isEqualTo("blocked"));
        assertThat(unused.requests()).isEmpty();
    }
