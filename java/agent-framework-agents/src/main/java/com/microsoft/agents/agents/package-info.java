 ...
 * lifecycle, bounded streaming, optimistic session persistence, attributed context/history
 * providers, session helpers, one-shot approval continuation, and agent/chat/function middleware
 * behavior.
 */
