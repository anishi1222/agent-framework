 ...
 * @param metadata immutable local-only metadata; it is never emitted on the A2A v1 wire
 */
public record AgentSkill(
    ...
    public static final class Builder {
        ...
        /**
         * Sets local-only metadata.
         *
         * <p>A2A v1 does not define a skill-level metadata member, so this value is intentionally
         * excluded from agent-card serialization. Advertise interoperable extensions through
         * {@link AgentCapabilities#extensions()} instead.
         */
